...
Built September 24, 2026 for contract year 2026 (5,556 plans, 3,137 counties, 10,519 pages). Live on GitHub Pages
...
- **Part D drug lookup:** appears when `site_data/2026/rx/` and `pdp/` exist (from `cms_refresh.py formulary --year 2026` then `export`). Drug pages under `/drugs/`, PDP pages under `/pdp/`, client data under `/data/rx`, `/data/pd`, `/data/pdp`. Re-run monthly; the CMS file changes mid-month.
